...
export const MOCK_SUBSCRIPTION_PLANS = [
  {
    ...
    monthlyPriceFCFA: 0,
    comingSoon: false,
    features: ["1 active event", "1 listed venue", "Standard visibility", "Email support"],
    featuresFr: ["1 événement actif", "1 lieu référencé", "Visibilité standard", "Support par email"],
    isPopular: false,
  },
  {
    id: "standard",
  ...
  },
  {
    ...
    features: [
      ...
      "Advanced statistics",
      "Boosted visibility across Africa",
