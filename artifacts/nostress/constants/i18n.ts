...
const baseTranslations = {
  fr: {
    ...
    onboarding1Sub: "Concerts, festivals, soirées — la vie nocturne pan-africaine à portée de main.",
    ...
    onboarding3Title: "Explorez votre ville",
    onboarding3Sub: "Découvrez les meilleurs bars, restaurants et salles de concert. La carte interactive vous guide.",
    onboardingJoinTitle: "Rejoignez NoStress",
    onboardingJoinSub: "Accédez aux meilleurs événements et lieux de votre ville.",
    onboardingCreateAccount: "Créer un compte",
    onboardingHaveAccount: "J'ai déjà un compte",
    onboardingGuest: "Continuer sans compte",
  ...
  en: {
    ...
    onboarding1Sub: "Concerts, festivals, nightlife — pan-African events at your fingertips.",
    ...
    onboarding3Title: "Explore your city",
    onboarding3Sub: "Discover the best bars, restaurants and concert halls. The interactive map guides you.",
    onboardingJoinTitle: "Join NoStress",
    onboardingJoinSub: "Access the best events and venues in your city.",
    onboardingCreateAccount: "Create an account",
    onboardingHaveAccount: "I already have an account",
    onboardingGuest: "Continue without account",
