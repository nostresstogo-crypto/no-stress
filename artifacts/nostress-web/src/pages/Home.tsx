  ...
  const plans = [
    {
      ...
      features: [
        t("home.pricing.p1.f1"),
        t("home.pricing.p1.f2"),
        t("home.pricing.p1.f3"),
        t("home.pricing.p1.f4"),
      ],
    },
    {
      ...
      features: [
        ...
        t("home.pricing.p2.f5"),
        t("home.pricing.p2.f6"),
      ],
    },
    {
      ...
      features: [
        ...
        t("home.pricing.p3.f5"),
        t("home.pricing.p3.f6"),
      ],
    },
  ];
        ...
        <section className="py-24 bg-card">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {plans.map((plan, i) => (
                <div key={i} className={`p-8 rounded-2xl border ${plan.popular ? "border-primary bg-background relative" : "border-border bg-background"}`}>
                  {plan.popular && (
